...
#
# However, when we do this, we also import `boto3facade/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'boto3facade = boto3facade.cli:boto3facade'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'boto3facade_gui = boto3facade.gui:entry_point'
        # ]
    }
)
